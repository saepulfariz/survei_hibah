...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url(); ?>" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SURVEI HIBAH</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block"><?= $this->session->userdata('username'); ?> - <?= $this->session->userdata('nama_role');; ?></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('survei'); ?>" class="nav-link <?= ($segment == 'survei') ? 'active' : ''; ?>">
