...
<section class="content">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('survei/' . $survei['id_survei']); ?>" method="post">
            <input type="hidden" name="method" id="method" value="put">
            <input type="hidden" id="id_survei" value="<?= $survei['id_survei']; ?>">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_lembaga" name="nama_lembaga" placeholder="nama_lembaga" value="<?= $survei['nama_lembaga']; ?>">
                            </div>
                            <?= form_error('nama_lembaga', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>

                            <div class="form-group">
                                <label for="alamat_lembaga">Alamat</label>
                                <input type="text" class="form-control" id="alamat_lembaga" name="alamat_lembaga" placeholder="alamat_lembaga" value="<?= $survei['alamat_lembaga']; ?>">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ketua_nama" name="ketua_nama" placeholder="Nama" value="<?= $survei['ketua_nama']; ?>">
                                    </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ketua_nik" name="ketua_nik" placeholder="NIK" value="<?= $survei['ketua_nik']; ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sekretaris_nama" name="sekretaris_nama" placeholder="Nama" value="<?= $survei['sekretaris_nama']; ?>">
                                    </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="sekretaris_nik" name="sekretaris_nik" placeholder="NIK" value="<?= $survei['sekretaris_nik']; ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bendahara_nama" name="bendahara_nama" placeholder="Nama" value="<?= $survei['bendahara_nama']; ?>">
                                    </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bendahara_nik" name="bendahara_nik" placeholder="NIK" value="<?= $survei['bendahara_nik']; ?>">
                                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nomor_legalitas" name="nomor_legalitas" placeholder="nomor_legalitas" value="<?= $survei['nomor_legalitas']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tanggal_legalitas" name="tanggal_legalitas" placeholder="tanggal_legalitas" value="<?= $survei['tanggal_legalitas']; ?>">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_bjb" name="no_bjb" placeholder="no_bjb" value="<?= $survei['no_bjb']; ?>">
                            </div>
                            <?= form_error('no_bjb', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>

                            <div class="form-group">
                                <label for="nama_bjb">Nama BJB</label>
                                <input type="text" class="form-control" id="nama_bjb" name="nama_bjb" placeholder="nama_bjb" value="<?= $survei['nama_bjb']; ?>">
                            </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="surat_penyataan_keaslian_nomor" name="surat_penyataan_keaslian_nomor" placeholder="surat_penyataan_keaslian_nomor" value="<?= $survei['surat_penyataan_keaslian_nomor']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="surat_keterangan_domisili_nomor" name="surat_keterangan_domisili_nomor" placeholder="surat_keterangan_domisili_nomor" value="<?= $survei['surat_keterangan_domisili_nomor']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tidak_dapat_hibah_tahun_lalu" name="tidak_dapat_hibah_tahun_lalu" placeholder="tidak_dapat_hibah_tahun_lalu" value="<?= $survei['tidak_dapat_hibah_tahun_lalu']; ?>">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_npwp" name="no_npwp" placeholder="no_npwp" value="<?= $survei['no_npwp']; ?>">
                            </div>
                            <?= form_error('no_npwp', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>

                            <div class="form-group">
                                <label for="nama_npwp">Nama NPWP</label>
                                <input type="text" class="form-control" id="nama_npwp" name="nama_npwp" placeholder="nama_npwp" value="<?= $survei['nama_npwp']; ?>">
                            </div>
                            <?= form_error('nama_npwp', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>

                            <div class="form-group">
                                <label for="no_hp">No Hp</label>
                                <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="no_hp" value="<?= $survei['no_hp']; ?>">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="indentitas" rows="3" name="indentitas" placeholder="indentitas"><?= $survei['indentitas']; ?></textarea>
                            </div>
                            <?= form_error('indentitas', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>

                            <div class="form-group">
                                <label for="latar_belakang">Latar Belakang</label>
                                <textarea type="text" class="form-control" id="latar_belakang" rows="6" name="latar_belakang" placeholder="latar_belakang"><?= $survei['latar_belakang']; ?></textarea>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="maksud_tujuan" rows="6" name="maksud_tujuan" placeholder="maksud_tujuan"><?= $survei['maksud_tujuan']; ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="rincian_kegiatan" rows="6" name="rincian_kegiatan" placeholder="rincian_kegiatan"><?= $survei['rincian_kegiatan']; ?></textarea>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="usulan" id="usulan" placeholder="usulan" value="<?= $survei['usulan']; ?>">
                            </div>
                            <?= form_error('usulan', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>

                            <div class="form-group">
                                <label for="rekomendasi">Rekomendasi</label>
                                <input type="text" class="form-control" id="rekomendasi" name="rekomendasi" placeholder="rekomendasi" value="<?= $survei['rekomendasi']; ?>">
                            </div>
