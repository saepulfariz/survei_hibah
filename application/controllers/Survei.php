...
class Survei extends CI_Controller
{
	...
	public function edit($id)
	{
		...
		$data['legalitas'] = $this->survei->getEnum('legalitas');
		$data['status_tanah'] = $this->survei->getEnum('status_tanah');
		$this->template->load('template/index', 'survei/edit', $data);
	}
	...
	public function update($id)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$res = $this->survei->update($id, $data);
			...
			$id = $this->administrasi->where('id_survei', $id_survei)['id_survei'];
			$this->administrasi->update($id, $data_administrasi);
			...
			$id = $this->rekomendasi->where('id_survei', $id_survei)['id_survei'];

			$this->rekomendasi->update($id, $data_rekomendasi);
